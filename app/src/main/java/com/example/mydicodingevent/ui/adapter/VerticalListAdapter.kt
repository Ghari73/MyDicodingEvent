...
class VerticalListAdapter(): ListAdapter<ListEventsItem, VerticalListAdapter.MyViewVerticalHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewVerticalHolder {
        val binding = ItemHomeVertikalBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return MyViewVerticalHolder(binding)
    }

    override fun onBindViewHolder(holder: MyViewVerticalHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            intentDetail.putExtra(DetailActivity.INSTANCE_FRAGMENT, 2)
